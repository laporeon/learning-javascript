...
*/
pessoa.andar = function (value) {
  pessoa.caminhouQuantosMetros += value;
  pessoa.andando = true;
};
...
*/
console.log(pessoa.nomeCompleto()); // "Olá! Meu nome é Fernando Daciuk!"
...
retornada)
*/
console.log(pessoa.mostrarIdade()); // "Olá, eu tenho 37 anos!"
