...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, "JavaScript"));
...
*/
  ...
  console.log(text.replace(/\d/g, "-")); // text.replace(/[0-9]/g, "-");
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/g, function (frase) {
